      ...
      <div className='sidebar__filters'>
        ...
        <div className='sidebar__filters__filter'>
          ...
          <div className='sidebar__filters__filter__items'>
            <div className='sidebar__filters__filter__items__item'>
              <svg
                width='100%'
                viewBox='0 0 26 26'
                aria-hidden='true'
        ...
        <div className='sidebar__filters__filter'>
          <div className='sidebar__filters__filter__header' onClick={display}>
            <h4 className='sidebar__filters__filter__h4'>collar</h4>
            <svg
              className='up'
              width='20'
              height='5'
          ...
          <div className='sidebar__filters__filter__items'>
            ...
            <div className='sidebar__filters__filter__items__item'>
              ...
              >
                <defs>
                  <circle id='henley-icon-a' cx='12' cy='12' r='12'></circle>
                </defs>
                <g fill='none' fillRule='evenodd' transform='translate(1 1)'>
