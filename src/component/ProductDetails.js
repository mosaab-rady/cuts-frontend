  ...
  return (
    <section className='product__detail'>
      ...
      <div className='product__detail__sizes--container'>
        <div className='product__detail__sizes__header'>
          ...
          <div className='modal' id='myModal'>
            ...
            >
              ...
              <img src={'../img/size-chart.webp'} alt='size-chart' />
            </div>
          </div>
        </div>
      ...
      <div className='product__detail__fabric--features__container'>
        <h3 className='product__detail__fabric--features__heading'>
          product features
        </h3>
        <div className='product__detail__fabric--features'>
          {product.fabricFeatures.stretch ? (
            <div className='product__detail__fabric--features__feature'>
              <svg
                viewBox='0 0 168 168'
                fill='none'
              ...
              <h4 className='product__detail__fabric--features__feature__h4'>
                4-Way Stretch
              </h4>
            </div>
          ) : (
          ...
          {product.fabricFeatures.breathable ? (
            <div className='product__detail__fabric--features__feature'>
              <svg
                viewBox='0 0 200 182'
                fill='none'
          ...
          {product.fabricFeatures.durable ? (
            <div className='product__detail__fabric--features__feature'>
              <svg
                viewBox='0 0 218 207'
                fill='none'
          ...
          {product.fabricFeatures.lightweight ? (
            <div className='product__detail__fabric--features__feature'>
              <svg
                viewBox='0 0 263 157'
                fill='none'
          ...
          {product.fabricFeatures.naturalSoftness ? (
            <div className='product__detail__fabric--features__feature'>
              <svg
                viewBox='0 0 260 239'
                fill='none'
          ...
          {product.fabricFeatures.colorAndFitRetention ? (
            <div className='product__detail__fabric--features__feature'>
              <svg
                viewBox='0 0 188 172'
                fill='none'
          ...
          {product.fabricFeatures.antiPilling ? (
            <div className='product__detail__fabric--features__feature'>
              <svg
                viewBox='0 0 120 116'
                fill='none'
          ...
          {product.fabricFeatures.butterySoft ? (
            <div className='product__detail__fabric--features__feature'>
              <svg
                viewBox='0 0 169 102'
                fill='none'
          ...
          {product.fabricFeatures.preShrunk ? (
            <div className='product__detail__fabric--features__feature'>
              <svg
                viewBox='0 0 198 190'
                fill='none'
          ...
          {product.fabricFeatures.wrinkleFree ? (
            <div className='product__detail__fabric--features__feature'>
              <svg
                viewBox='0 0 196 80'
                fill='none'
