...
export default function AdominProductDetail() {
    ...
    const getData = async () => {
      ...
      if (res) {
        if (res.data.status === 'success') {
          ...
          setImageDetail(
            `${host}/api/v1/images/${res.data.data.product.imageDetail}`
          );
  ...
  const showTypes = () => {
    const types = document.getElementById(
      'account--body__productdetail__form__types'
    );
  ...
  const showCuts = () => {
    const cuts = document.getElementById(
      'account--body__productdetail__form__cuts'
    );
  ...
  const showCollars = () => {
    const collars = document.getElementById(
      'account--body__productdetail__form__collars'
    );
        ...
        >
          ...
          <div className='account--body__product__form__group'>
            ...
            <div className='account--body__product__form__options--container'>
              ...
              <div
                className='account--body__product__form__options'
                id='account--body__productdetail__form__types'
              >
                <h4
                  className='account--body__product__form__options__option'
                  onClick={() => {
          ...
          <div className='account--body__product__form__cutcollar'>
            <div className='account--body__product__form__group'>
              ...
              <div className='account--body__product__form__options--container'>
                ...
                <div
                  className='account--body__product__form__options'
                  id='account--body__productdetail__form__cuts'
                >
                  <h4
                    className='account--body__product__form__options__option'
                    onClick={() => {
            ...
            <div className='account--body__product__form__group'>
              ...
              <div className='account--body__product__form__options--container'>
                ...
                <div
                  className='account--body__product__form__options'
                  id='account--body__productdetail__form__collars'
                >
                  <h4
                    className='account--body__product__form__options__option'
                    onClick={() => {
              ...
              <div className='account--body__product__form__fabricfeatures'>
                <div className='account--body__product__form__fabricfeatures__feature'>
                  <input
                    type='checkbox'
                    name='stretch'
                    defaultChecked={product.fabricFeatures.stretch}
                  />
                  <label
                    htmlFor='stretch'
                ...
                <div className='account--body__product__form__fabricfeatures__feature'>
                  <input
                    type='checkbox'
                    name='breathable'
                    defaultChecked={product.fabricFeatures.breathable}
                  />
                  <label
                    htmlFor='breathable'
                    className='account--body__product__form__fabricfeatures__feature__label'
                ...
                <div className='account--body__product__form__fabricfeatures__feature'>
                  <input
                    type='checkbox'
                    name='durable'
                    defaultChecked={product.fabricFeatures.durable}
                  />
                  <label
                    htmlFor='durable'
                    className='account--body__product__form__fabricfeatures__feature__label'
                ...
                <div className='account--body__product__form__fabricfeatures__feature'>
                  <input
                    type='checkbox'
                    name='lightweight'
                    defaultChecked={product.fabricFeatures.lightweight}
                  />
                  <label
                    htmlFor='lightweight'
                    className='account--body__product__form__fabricfeatures__feature__label'
                ...
                <div className='account--body__product__form__fabricfeatures__feature'>
                  <input
                    type='checkbox'
                    name='naturalSoftness'
                    defaultChecked={product.fabricFeatures.naturalSoftness}
                  />
                  <label
                ...
                <div className='account--body__product__form__fabricfeatures__feature'>
                  <input
                    type='checkbox'
                    name='colorAndFitRetention'
                    defaultChecked={product.fabricFeatures.colorAndFitRetention}
                  />
                  <label
                ...
                <div className='account--body__product__form__fabricfeatures__feature'>
                  <input
                    type='checkbox'
                    name='antiPilling'
                    defaultChecked={product.fabricFeatures.antiPilling}
                  />
                  <label
                    htmlFor='antiPilling'
                    className='account--body__product__form__fabricfeatures__feature__label'
                ...
                <div className='account--body__product__form__fabricfeatures__feature'>
                  <input
                    type='checkbox'
                    name='butterySoft'
                    defaultChecked={product.fabricFeatures.butterySoft}
                  />
                  <label
                    htmlFor='butterySoft'
                    className='account--body__product__form__fabricfeatures__feature__label'
                ...
                <div className='account--body__product__form__fabricfeatures__feature'>
                  <input
                    type='checkbox'
                    name='preShrunk'
                    defaultChecked={product.fabricFeatures.preShrunk}
                  />
                  <label
                    htmlFor='preShrunk'
                    className='account--body__product__form__fabricfeatures__feature__label'
                ...
                <div className='account--body__product__form__fabricfeatures__feature'>
                  <input
                    type='checkbox'
                    name='wrinkleFree'
                    defaultChecked={product.fabricFeatures.wrinkleFree}
                  />
                  <label
                    htmlFor='wrinkleFree'
                    className='account--body__product__form__fabricfeatures__feature__label'
          ...
          <div className='account--body__product__form__sizes'>
            ...
            <div className='account--body__product__form__sizes--container'>
              <div className='account--body__product__form__group'>
                ...
                <input
                  type='number'
                  defaultValue={product.size.small}
                  min='0'
                  name='small'
                />
              </div>
              <div className='account--body__product__form__group'>
                ...
                <input
                  ...
                  name='medium'
                  min='0'
                  defaultValue={product.size.medium}
                />
              </div>
              <div className='account--body__product__form__group'>
                ...
                <input
                  type='number'
                  defaultValue={product.size.large}
                  min='0'
                  name='large'
                />
              </div>
              <div className='account--body__product__form__group'>
                ...
                <input
                  type='number'
                  defaultValue={product.size.xLarge}
                  min='0'
                  name='xLarge'
                />
              </div>
              <div className='account--body__product__form__group'>
                ...
                <input
                  type='number'
                  defaultValue={product.size.xxLarge}
                  min='0'
                  name='xxLarge'
                />
              </div>
          ...
          <div className='account--body__product__form__group'>
            ...
            <textarea
              ...
              defaultValue={product.sizeAndFit.join('\n')}
            ></textarea>
          </div>
          <div className='account--body__product__form__group'>
          ...
          <div className='account--body__product__form__imgs'>
            <h3 className='account--body__product__form__sizes__h3'>
              images :
            </h3>
